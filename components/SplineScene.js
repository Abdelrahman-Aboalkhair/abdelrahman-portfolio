...
const SplineScene = ({
    ...
    // Validate scene URL
    const isValidSplineUrl = sceneUrl &&
        sceneUrl.includes('spline.design') &&
        sceneUrl.endsWith('.splinecode') &&
        !sceneUrl.includes('https://my.spline.design/interactiveworkspace-6nLCy8Pi5nxZqcXTILlJ5iMs/') &&
        sceneUrl !== "<iframe src='https://my.spline.design/interactiveworkspace-6nLCy8Pi5nxZqcXTILlJ5iMs/' frameborder='0' width='100%' height='100%'></iframe>";
        ...
        return fallback || (
            <div className={`flex items-center justify-center ${className}`}>
                <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-4">3D Scene Preview</p>
                </div>
            </div>
        );
    }
