        ...
        >
            <div className="flex flex-col lg:flex-row items-center justify-between">
                ...
                <div className="lg:w-1/2 text-center lg:text-left">
                    ...
                    >
                        <motion.h1
                            className="text-4xl sm:text-6xl lg:text-7xl xl:text-7xl font-black mb-6"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        <motion.h2
                            className="text-2xl sm:text-3xl lg:text-4xl xl:text-4xl font-medium text-white mb-4"
                        ...
                        >
                            I've been diving deep into web development, building and refining projects
                            that bring ideas to life. When I'm not coding, I'm learning new skills and
                            exploring ways to solve real-world problems with tech.
                        </motion.p>
                ...
                >
                    <SplineScene
                        sceneUrl="https://prod.spline.design/Hwjz8oLv9WN8ejij/scene.splinecode"
